...
# ---------------------------------------------------------
    ...
    def RadioLF(self, G_history):
        ...
        snap = 63
        w1 = np.where((G_history[snap].RadioLuminosity[:,5] > 0)& (G_history[snap].StellarMass > 0)& (G_history[snap].fcool > 0))[0]
        Lradio1400_5 = np.log10(2.0 * G_history[snap].RadioLuminosity[w1,5])
...
if __name__ == '__main__':
    ...
    OutputDir = '/Users/mojtabaraouf/sage-master/plots/'
